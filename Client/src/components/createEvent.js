...
/**
 * CreateEvent lets administrators compose a new event with optional imagery.
 * A live preview mirrors the public card layout so staff can visualise the post
 * before submitting the multipart request to the backend.
 */
const CreateEvent = () => {
  // Store basic event fields in one state object to simplify form handling
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Express route expects the field name `images`
            ...
            <Col md={7}>
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group className="mb-4">
                  ...
                  {/* Single input is enough because we assemble FormData manually */}
                  <Form.Control
                    type="file"
                  ...
                  <div className="d-flex flex-wrap gap-2 mt-2">
                    {files.map((f, i) => (
                      // URL.createObjectURL is safe here because we reset previews on submit
